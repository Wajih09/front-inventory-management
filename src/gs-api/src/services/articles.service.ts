...
class ArticlesService extends __BaseService {
  static readonly findAllPath = '/gestiondestock/v1/errorMsg/all';
  static readonly savePath = '/gestiondestock/v1/article/create';
  static readonly deletePath = '/gestiondestock/v1/article/delete/{idArticle}';
  ...
  static readonly findByIdPath = '/gestiondestock/v1/article/{idArticle}';
  ...
  findAllResponse(): __Observable<__StrictHttpResponse<Array<ArticleDto>>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/gestiondestock/v1/article/all`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  saveResponse(body?: ArticleDto): __Observable<__StrictHttpResponse<ArticleDto>> {
    ...
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/gestiondestock/v1/article/create`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  deleteResponse(idArticle: number): __Observable<__StrictHttpResponse<null>> {
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `/gestiondestock/v1/article/${idArticle}`,
      __body,
      {
        headers: __headers,
        params: __params,
